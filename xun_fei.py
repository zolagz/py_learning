...
from voice_dev.app_conf import  Save_Path
...
class XFtts(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, ):
        ...
        self.BusinessArgs = {"aue": "raw", "auf": "audio/L16;rate=16000", "vcn": "xiaoxue", "tte": "utf8",
                             "ent": "aisound"}  # TODO
...
APPID = conf.getint("XUNFEI", "AppId")
APIKey = conf.get("XUNFEI", "SecretId")
APISecret = conf.get("XUNFEI", "SecretKey")




def tts_say_wave(text):
    import wave
    ...
    # audiosum += audio
    Save_Path = 'data/' + str(int(time.time() * 1000)) + '.MP3'
